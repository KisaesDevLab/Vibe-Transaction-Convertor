...
export const detectMultiAccount = (pages: PageText[]): MultiAccountAnalysis => {
  ...
  // Forward-fill gaps from the previous identified page.
  ...
  // Back-fill any leading nulls from the first identified.
  ...
  return { multiAccount: true, occurrences, uniqueLast4, splits };
};
